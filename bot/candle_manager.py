...
class CandleManager:
    ...
    def update_timings(self):
        ...
        #for each pair in self.pairs_list, which is loaded through trade_settings (that is in models), checks if there are ready candles,
        #and, in case, it updates the log and append to triggered, which is finally returned
        triggered = []
